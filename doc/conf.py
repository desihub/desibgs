# -*- coding: utf-8 -*-
#
# desibgs documentation build configuration file, created by
...
latex_documents = [
  ('index', 'desibgs.tex', u'desibgs Documentation',
   u'DESI', 'manual'),
]
...
man_pages = [
    ('index', 'desibgs', u'desibgs Documentation',
     [u'DESI'], 1)
]
...
texinfo_documents = [
  ('index', 'desibgs', u'desibgs Documentation',
   u'DESI', 'desibgs', 'One line description of project.',
   'Miscellaneous'),
]
